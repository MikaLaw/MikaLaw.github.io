...
$(document).ready(function () {
  ...
  */
  ...
  function filterParams(selector) {
    ...
    var $trigerBtn = $(selector).find('[data-js-tabselect-range]');
    ...
    function deleteRangeVal(btnId) {
      var $btnRange = $('[data-js-tabselect-range]');
      if (btnId) {
        $btnRange = $('[data-js-tabselect-range][data-id=' + btnId + ']');
      }
      var $slider = $btnRange.closest('[data-js-tabselect-range-wrap]').find('.slider-range');
      var $leftSlider = $slider.next().find('[data-js-tabselect-range-left]');
      var $rightSlider = $slider.next().find('[data-js-tabselect-range-right]');
      var $selectPlacehilder = $btnRange.closest('[data-js-tabselect]').find('[data-display]');
    ...
    function deleteRadioVal(input) {
      ...
      var $selectPlacehilder = $(item).closest('[data-js-tabselect]').find('[data-display]');
      $selectPlacehilder.text($selectPlacehilder.attr('data-placeholder')).addClass('placeholder').removeClass('is-multiple');
    }
    ...
    if ($(window).outerWidth() >= 1024) {
      ...
      $trigerBtn.on('click', function () {
        var id = $(this).attr('data-id');
        var minVal = $(this).parent().find('[data-js-tabselect-range-left]').val();
        var maxVal = $(this).parent().find('[data-js-tabselect-range-right]').val();
  ...
  */
  $('.js-tabs-active').each(function (_, item) {
    var $item = $(item);
