...
$(document).ready(function () {
  ...
  */
  $(document).on(
    'click',
    '[js-password-input] [class*="__visibility-btn"]',
    function () {
  ...
  */  
  ...
  $('[js-discount-more]').on('click', function (e) { 
  ...
  */
  ...
  function filterParams(selector) {
    ...
    let $trigerBtn = $(selector).find('[data-js-tabselect-range]');
    ...
    function deleteRangeVal(btnId) {
      let $btnRange = $('[data-js-tabselect-range]');
      if (btnId) {
        $btnRange = $('[data-js-tabselect-range][data-id=' + btnId + ']');
      }
      let $slider = $btnRange.closest('[data-js-tabselect-range-wrap]').find('.slider-range');
      let $leftSlider = $slider.next().find('[data-js-tabselect-range-left]')
      let $rightSlider = $slider.next().find('[data-js-tabselect-range-right]')
      let $selectPlacehilder = $btnRange.closest('[data-js-tabselect]').find('[data-display]');
    ...
    function deleteRadioVal(input) {
      ...
      let $selectPlacehilder = $(item).closest('[data-js-tabselect]').find('[data-display]');
      $selectPlacehilder.text($selectPlacehilder.attr('data-placeholder')).addClass('placeholder').removeClass('is-multiple')
    }
    ...
    if ($(window).outerWidth() >= 1024){
      ...
      $trigerBtn.on('click', function () {
        let id = $(this).attr('data-id');
        let minVal = $(this).parent().find('[data-js-tabselect-range-left]').val();
        let maxVal = $(this).parent().find('[data-js-tabselect-range-right]').val();
  ...
  */
  ...
  $('[article-new-slider]').each(function () {
    let $block = $(this);
    let $init = $block.find('[class*="__list"]');
    let $prev = $block.find('[class*="_prev"]');
    let $next = $block.find('[class*="_next"]');
  ...
  $('[course-page-slider]').each(function () {
  ...
  $('[main-stock-slider]').each(function () {
    let $block = $(this);
    let $init = $block.find('[class*="__list"]');
  ...
  $('[rebate-system-slider]').each(function () {
    let $block = $(this);
    let $init = $block.find('[class*="__list"]');
