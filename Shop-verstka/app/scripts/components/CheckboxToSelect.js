...
module.exports.CheckboxToSelect = function () {
	...
	function CheckboxToSelect(selector){
		...
		$(document).on('click.cts', selector + ' [data-js-tabselect-clear]', function(e){
			e.preventDefault();
			e.stopPropagation();
			const $select = $(e.target).parents('[data-js-tabselect]');
		...
		$(document).on('click.cts', selector + ' [data-js-tabselect-range]', function (e) {
			var $display = $(this).closest(selector).find('[data-display]');
			var leftVal = $(this).parent().find('[data-js-tabselect-range-left]').val();
			var rightVal = $(this).parent().find('[data-js-tabselect-range-right]').val();
	...
	CheckboxToSelect('[data-js-tabselect]');
};
